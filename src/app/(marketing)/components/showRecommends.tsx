...
// * Components * //
export default function ShowRecommends() {


    return (
        <section className="flex items-center justify-center py-16 min-w-screen tails-selected-element">
            <div className="max-w-6xl px-12 mx-auto  md:px-16 xl:px-10">
                <div className="flex flex-col items-center lg:flex-row">
                    ...
                    <div className="w-full lg:w-1/2">
                        ...
                        <motion.div initial="hidden" whileInView="show" variants={textVariant(.15)}
                        >
                        ...
                        <motion.div initial="hidden" whileInView="show" variants={textVariant(.2)}
                        >
                            <blockquote className="flex items-center justify-between w-full col-span-1 p-6 mt-4 bg-white rounded-lg shadow" data-rounded="rounded-lg" data-rounded-max="rounded-full">
                                <div className="flex flex-col pr-10">
                                    <div className="relative pl-12">
