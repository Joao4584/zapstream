...
import CardSection from "../card/CardSections";
import {
    Breadcrumb,
    BreadcrumbItem,
    BreadcrumbLink,
...
export default function BreadCrumb({ items }: BreadcrumbProps) {
    return (
        <CardSection className="w-full mb-2 my-0 p-6 py-3 flex justify-between items-center">
            <Breadcrumb>
                <BreadcrumbList>
            ...
            <DropdownMenu>
                <DropdownMenuTrigger asChild>
                    <div className="w-8 flex justify-center items-center h-full dark:bg-slate-800 dark:bg-opacity-20 p-1 rounded-md border border-gray-1">
                        <MdNotifications className="h-5 w-5" />
                    </div>
                </DropdownMenuTrigger>
                <DropdownMenuContent className="rounded-none dark:rounded-e-none -ml-100 ">
                <div className="flex h-screen w-full flex-col items-center justify-center gap-y-2">
  <div className="w-[300px] rounded-xl border border-gray-200  py-4 px-2 shadow-md shadow-gray-100">
